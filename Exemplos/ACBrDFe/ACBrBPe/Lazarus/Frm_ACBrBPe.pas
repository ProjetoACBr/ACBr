...
uses
  ...
  ACBrBPe, ACBrBPeDABPEClass, ACBrBPeDABPeESCPOS, ACBrMail, ACBrUtil,
  ACBrDFe, ACBrDFeSSL, ACBrDFeReport, ACBrPosPrinter;
...
uses
  ...
  ACBrXmlBase,
  ACBrDFe.Conversao,
  pcnAuxiliar, ACBrBPeClass, ACBrBPeConversao,
...
begin
  vChave := '';
  if not(InputQuery('WebServices Consultar', 'Chave do BP-e:', vChave)) then
    exit;
...
procedure TfrmACBrBPe.LoadXML(MyMemo: TMemo; SynEdit: TSynEdit);
var
  vText: String;
begin
  vText := MyMemo.Text;
