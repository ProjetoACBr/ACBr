...
uses
  ...
  SynHighlighterXML, {OleCtrls, SHDocVw,} ShellAPI, {XMLIntf, XMLDoc,} zlib,
  ACBrBase, ACBrUtil.Base, ACBrUtil.XMLHTML, ACBrUtil.FilesIO,
  ACBrUtil.DateTime, ACBrUtil.Strings, ACBrDFe, ACBrDFeReport, ACBrMail,
  ACBrDCe, ACBrDCe.DACEClass, ACBrDCe.DACERLClass;
...
procedure TfrmACBrDCe.LoadXML(MyMemo: TMemo; SynEdit: TSynEdit);
var
  vText: String;
begin
  vText := MyMemo.Text;
