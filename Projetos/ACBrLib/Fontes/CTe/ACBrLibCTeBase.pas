        ...
        try
          ...
          begin
            try
              ...
              if EhArquivo then
                ACBrCTe1.WebServices.DistribuicaoDFe.retDistDFeInt.CarregarArquivo(ArquivoOuXml)
              else
                ACBrCTe1.WebServices.DistribuicaoDFe.retDistDFeInt.XmlRetorno := ArquivoOuXml;
