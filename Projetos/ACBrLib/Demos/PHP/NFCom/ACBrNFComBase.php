...
<head>
    <meta charset="UTF-8">
    <meta name="ACBrNFCom" content="width=device-width, initial-scale=1.0">
    <title>
        <?php
        $title = 'ACBrNFCom';
        if (isset($_GET['modo']))
        ...
        <div class="tabsPanel">
            ...
            <div id="configuracoes" class="panelAba selecionado panelEsquerda-container">
                <div class="tabsPanel">
                    ...
                    <div id="geral" class="panelAba selecionado panelConfiguracoes-container">
                        ...
                        <div class="form-group">
                            ...
                            <select id="versaoDF" name="versaoDF">
                                <option value="0" selected>ve100</option>
                            </select>
                        </div>
                        <div class="grid2Col">
                    ...
                    <div id="arquivos" class="panelAba panelConfiguracoes-container">
                        ...
                        <div class="grid2Col">
                            <label for="EmissaoPathNFCom">Salvar Doc. pelo campo Data de Emissão</label>
                            <input type="checkbox" id="EmissaoPathNFCom">
                        </div>
                        <div class="grid2Col">
                        ...
                        <br>
                        <div class="form-group">
                            <label for="PathNFCom">Pasta Arquivos NFCom</label>
                            <input type="text" id="PathNFCom">
                        </div>
                        <div class="form-group">
            ...
            <div id="documento-auxiliar" class="panelAba panelEsquerda-container">
                ...
                <div class="grid2Col">
                    <label>DANFCOM</label>
                    <div>
                        <input type="radio" id="danfcomRetrato" name="TipoDANFCom" value="0" checked>
                        <label for="danfcomRetrato">Retrato</label>
                        <input type="radio" id="danfcomPaisagem" name="TipoDANFCom" value="1">
                        <label for="danfcomPaisagem">Paisagem</label>
                    </div>
                </div>
                -->
            </div>
    ...
    <div class="cfgPanelDireita">
        <div class="tabsPanel">
            ...
            <div id="envio" class="panelAba selecionado button-container">
                <div class="grid3Col">
                    <input type="button" id="EnviarXml" value="Enviar (xml)">
                    <input type="button" id="EnviarIni" value="Enviar (ini)">
                    <input type="button" id="ImprimirPDF" value="Imprimir PDF DANFCom">
                    ...
                    <input type="button" id="EnviarEmail" value="Enviar NFCom Email">
                </div>
            </div>
            ...
            <div id="eventos" class="panelAba button-container">
                <div class="grid2Col">
                    <input type="button" id="Cancelar" value="Cancelar NFCom">
    ...
    <script>
        ...
        $('#salvarConfiguracoes').on('click', function() {
            const infoData = {
                ...
                EmissaoPathNFCom: $('#EmissaoPathNFCom').prop('checked') ? 1 : 0,
                ...
                // Habilitar, caso seja implementado leiaute paisagem                
                // TipoDANFCom: parseInt($('input[name="TipoDANFCom"]:checked').val(), 10),
        ...
        $('#EnviarXml').on('click', function() {
            selecionarArquivo(".xml", function(AeArquivoNFCom) {
                chamaAjaxEnviar({
                    metodo: "Enviar",
                    tipoArquivo: "xml",
                    AeArquivoNFCom: AeArquivoNFCom,
                    AImprimir: 0
                });
            });
        });

        $('#EnviarIni').on('click', function() {
            selecionarArquivo(".ini", function(AeArquivoNFCom) {
                chamaAjaxEnviar({
                    metodo: "Enviar",
                    tipoArquivo: "ini",
                    AeArquivoNFCom: AeArquivoNFCom,
        ...
        $('#ValidarRegrasdeNegocios').on('click', function() {
            selecionarArquivo(".xml", function(AeArquivoXmlNFCom) {
                chamaAjaxEnviar({
                    metodo: "ValidarRegrasdeNegocios",
                    AeArquivoXmlNFCom: AeArquivoXmlNFCom
                });
            });
        });

        $('#ConsultarComChave').on('click', function() {
            inputBox("Digite a chave da NFCom:", function(eChaveOuNFCom) {
                chamaAjaxEnviar({
                    metodo: "Consultar",
                    eChaveOuNFCom: eChaveOuNFCom,
                    AExtrairEventos: 1
                });
            });
        });
        ...
        function chamaAjaxEnviar(infoData) {
            ...
            // Ex: http://localhost/NFCom/ACBrNFComBase.php?modo=MT
            // Ex: http://localhost/NFCom/ACBrNFComBase.php?modo=ST
            var modo = "<?php echo $modo; ?>";
            if (modo == "")
                modo = "MT";

            $.ajax({
                url: modo + '/ACBrNFComServicos' + modo + '.php',
                type: 'POST',
                data: infoData,
        ...
        function processaRetornoConfiguracoes(response) {
            if (response.dados) {
                ...
                $('#EmissaoPathNFCom').prop('checked', response.dados.EmissaoPathNFCom == 1);
                ...
                $('#PathNFCom').val(response.dados.PathNFCom);
                ...
                // Habilitar, caso seja implementado leiaute paisagem                
                // $('input[name="TipoDANFCom"][value="' + response.dados.TipoDANFCom + '"]').prop('checked', true);
