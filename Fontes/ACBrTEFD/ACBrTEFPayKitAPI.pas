...
resourcestring
  sErrCNPJNaoInformado = 'CNPJ do Estabelecimento, não informado';
  sErrEmpresaNaoInformada = 'Número de Empresa não informado';
...
begin
  ...
  begin
    ...
    // Verificando se é Erro de Transação pendente //
