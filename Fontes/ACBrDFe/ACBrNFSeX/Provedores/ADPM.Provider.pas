...
type
  TACBrNFSeXWebserviceADPM203 = class(TACBrNFSeXWebserviceSoap11)
  public
  ...
  TACBrNFSeProviderADPM203 = class (TACBrNFSeProviderABRASFv2)
  protected
...
procedure TACBrNFSeProviderADPM203.Configuracao;
begin
...
function TACBrNFSeProviderADPM203.CriarGeradorXml(
  const ANFSe: TNFSe): TNFSeWClass;
begin
  Result := TNFSeW_ADPM203.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderADPM203.CriarLeitorXml(
  const ANFSe: TNFSe): TNFSeRClass;
begin
  Result := TNFSeR_ADPM203.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderADPM203.CriarServiceClient(
...
begin
  ...
  if URL <> '' then
    Result := TACBrNFSeXWebserviceADPM203.Create(FAOwner, AMetodo, URL)
  else
  begin
...
{ TACBrNFSeXWebserviceADPM203 }

function TACBrNFSeXWebserviceADPM203.Recepcionar(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.RecepcionarSincrono(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.GerarNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.ConsultarLote(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.ConsultarNFSePorFaixa(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.ConsultarNFSePorRps(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.ConsultarNFSeServicoPrestado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.ConsultarNFSeServicoTomado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.Cancelar(const ACabecalho, AMSG: String): string;
var
  Request: string;
begin
  FPMsgOrig := AMSG;
...
function TACBrNFSeXWebserviceADPM203.SubstituirNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceADPM203.TratarXmlRetornado(
