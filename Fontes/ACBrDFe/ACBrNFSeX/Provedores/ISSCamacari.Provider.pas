...
type
  TACBrNFSeXWebserviceISSCamacari201 = class(TACBrNFSeXWebserviceSoap11)
  public
  ...
  TACBrNFSeProviderISSCamacari201 = class (TACBrNFSeProviderABRASFv2)
  protected
...
{ TACBrNFSeProviderISSCamacari201 }

procedure TACBrNFSeProviderISSCamacari201.Configuracao;
begin
...
function TACBrNFSeProviderISSCamacari201.CriarGeradorXml(
  const ANFSe: TNFSe): TNFSeWClass;
begin
  Result := TNFSeW_ISSCamacari201.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderISSCamacari201.CriarLeitorXml(
  const ANFSe: TNFSe): TNFSeRClass;
begin
  Result := TNFSeR_ISSCamacari201.Create(Self);
  Result.NFSe := ANFSe;
end;

function TACBrNFSeProviderISSCamacari201.CriarServiceClient(
...
begin
  ...
  if URL <> '' then
    Result := TACBrNFSeXWebserviceISSCamacari201.Create(FAOwner, AMetodo, URL)
  else
  begin
...
{ TACBrNFSeXWebserviceISSCamacari201 }

function TACBrNFSeXWebserviceISSCamacari201.Recepcionar(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.RecepcionarSincrono(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.GerarNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.ConsultarLote(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.ConsultarNFSePorFaixa(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.ConsultarNFSePorRps(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.ConsultarNFSeServicoPrestado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.ConsultarNFSeServicoTomado(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.Cancelar(const ACabecalho, AMSG: String): string;
var
  Request: string;
begin
  FPMsgOrig := AMSG;
...
function TACBrNFSeXWebserviceISSCamacari201.SubstituirNFSe(const ACabecalho,
  AMSG: String): string;
var
  Request: string;
begin
...
function TACBrNFSeXWebserviceISSCamacari201.TratarXmlRetornado(
