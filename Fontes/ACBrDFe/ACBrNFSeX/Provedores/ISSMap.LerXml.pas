...
type
  ...
  TNFSeR_ISSMap = class(TNFSeRClass)
  private
...
procedure TNFSeR_ISSMap.LerInformacoesCancelamento(const ANode: TACBrXmlNode);
var
...
function TNFSeR_ISSMap.LerXml: Boolean;
var
...
function TNFSeR_ISSMap.LerXmlNfse(const ANode: TACBrXmlNode): Boolean;
var
...
function TNFSeR_ISSMap.LerXmlRps(const ANode: TACBrXmlNode): Boolean;
var
  AuxNode: TACBrXmlNode;
  ANodes: TACBrXmlNodeArray;
  i: Integer;
