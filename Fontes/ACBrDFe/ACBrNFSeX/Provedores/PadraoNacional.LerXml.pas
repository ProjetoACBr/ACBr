...
begin
  ...
  IBSCBS.xTpEnteGov := ObterConteudo(ANode.Childrens.FindAnyNs('xTpEnteGov'), tcStr);
  IBSCBS.indPessoas := StrToindPessoas(ObterConteudo(ANode.Childrens.FindAnyNs('indPessoas'), tcStr));
