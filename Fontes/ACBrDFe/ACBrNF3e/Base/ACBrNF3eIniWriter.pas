...
procedure TNF3eIniWriter.Gerar_IBSCBS_gIBSCBS_gEstornoCred(AINIRec: TMemIniFile;
...
procedure TNF3eIniWriter.Gerar_IBSCBSTot_gEstornoCred(AINIRec: TMemIniFile;
